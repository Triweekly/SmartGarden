...
let titleWord1 = (firstWord.charAt(0).toUpperCase.toString)+firstWord.substring(1);
let titleWord2 = "";
let titleWord3 = "";
if(words[1]!=null)
{
    titleWord2 = (secondWord.charAt(0).toUpperCase.toString)+secondWord.substring(1);
}

if(words[2]!=null)
{
    titleWord3 = (thirdWord.charAt(0).toUpperCase.toString)+thirdWord.substring(1);
}
